...
// Corps des mentions légales, sans titre ni <Seo> : rendu à l'identique par la
// page /mentions-legales et par la modale (voir legalDocuments.js).
    ...
    <div className="legal-body">
      ...
      <div className="legal-section">
        ...
        <p>
          ...
          notre{' '}
          <LegalLink documentKey="politique-rgpd" className="legal-link">
