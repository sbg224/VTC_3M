...
// Corps de la politique de confidentialité, sans titre ni <Seo> : rendu à
// l'identique par la page /politique-rgpd et par la modale (voir legalDocuments.js).
export default function PolitiqueRGPDContent() {
  return (
